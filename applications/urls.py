...
from .views import ApplicationView,MyApplicationsView,AddApplicationView,JobApplicationsView,application_done_job,ApplicantProfileView,cancel_application, reject_job
# ,approve_application
...
urlpatterns = [
    ...
    path('<application_uuid>/done',application_done_job,name='done_job'),

...
from .views import BlogListView,DeleteBlogView,BlogDetailView,UpdateBlogView,TagView,AddBlogView,LikeView,CommentReplyView
urlpatterns = [
    ...
    path('<blog_slug>/comment/<slug>/reply',CommentReplyView.as_view(), name="reply"),
